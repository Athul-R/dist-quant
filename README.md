...
This branch (`dacq/fresh/siddhant`) is a research fork of [llm-awq](https://github.com/mit-han-lab/llm-awq) for **Distribution-Aware Companding Quantization (DACQ)** of LLMs.
